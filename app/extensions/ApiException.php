...
class ApiException extends Exception
{
    ...
    public const SYSTEM_NOT_FOUND       = 100007;
    public const SYSTEM_METHOD_ERROR    = 100008;
    public const SYSTEM_IP_ILLEGAL      = 100009;
    public const SYSTEM_IP_LIMIT        = 100010;
    public const SYSTEM_USER_LIMIT      = 100011;
    public const SYSTEM_USER_VIP_LIMIT  = 100011;
